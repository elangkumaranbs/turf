...
import { Loader2, Lock, LockOpen, CalendarOff, WifiOff, User, Trash2, ChevronDown } from 'lucide-react';
...
export default function BlockSlotsPage() {
    ...
    const handleBlockSlots = async () => {
        ...
        try {
            ...
            setSuccessMsg(`${selectedSlots.length} slot${selectedSlots.length > 1 ? 's' : ''} blocked successfully!`);
            setSelectedSlots([]);
            setCustomerName('');
                            ...
                            <div className="mt-4 pt-4 border-t border-white/10 space-y-4">
                                ...
                                <div className="flex items-center gap-3 flex-wrap">
                                    <Button
                                        ...
                                        disabled={blocking}
                                        isLoading={blocking}
                                        className="bg-orange-500 hover:bg-orange-600 text-white border-orange-400/50 shadow-[0_0_20px_rgba(249,115,22,0.3)] h-11 px-6"
                                    >
