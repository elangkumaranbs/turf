                        ...
                        <div className="lg:col-span-1 space-y-4">
                            ...
                            {turfs.map(turf => (
                                <button
                                    ...
                                    className={`w-full text-left p-4 rounded-xl border transition-all ${selectedTurf === turf.id
                                ...
                                {bookings.length === 0 ? (
                                    ...
                                    <div className="space-y-4">
                                        {bookings.map(booking => (
                                            <div key={booking.id} className="bg-white/5 border border-white/10 p-4 rounded-lg flex justify-between items-center">
                                                <div>
