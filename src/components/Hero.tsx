    ...
    return (
        <section className="relative min-h-svh sm:min-h-screen w-full flex items-center justify-center pt-16 sm:pt-24 pb-0 sm:pb-16 px-4 overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center">
                ...
                >
                    <div className="inline-block px-3 py-1.5 sm:px-4 rounded-full bg-[var(--turf-green)]/10 border border-[var(--turf-green)]/20 text-[var(--turf-green)] font-medium text-sm sm:text-sm">
                        New: Priority Booking Available
                    </div>

                    <h1 className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-bold leading-tight text-white tracking-tight px-2">
                    ...
                    <p className="text-lg sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed px-2">
